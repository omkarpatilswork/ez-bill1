      ...
      {loading ? (
        ...
        <>
          ...
          <div className="glass-card rounded-2xl p-5 space-y-3">
            ...
            {info.phone && (
              <a href={`tel:${info.phone}`} className="flex items-center gap-3 p-2.5 rounded-lg bg-secondary/30 hover:bg-secondary/50 transition-colors active:scale-[0.98]">
                <Phone className="h-4 w-4 text-primary shrink-0" />
                <span className="text-sm text-foreground">{info.phone}</span>
              </a>
            )}
            {info.email && (
              <a href={`mailto:${info.email}`} className="flex items-center gap-3 p-2.5 rounded-lg bg-secondary/30 hover:bg-secondary/50 transition-colors active:scale-[0.98]">
            ...
            {info.website && (
              <a href={info.website} target="_blank" rel="noopener noreferrer"
                className="flex items-center gap-3 p-2.5 rounded-lg bg-secondary/30 hover:bg-secondary/50 transition-colors active:scale-[0.98]">
